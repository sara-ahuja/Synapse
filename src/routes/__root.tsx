...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered marketplace connecting brands and creators. Discover talent, launch campaigns, and build lasting collaborations with MatchIQ." },
      { name: "author", content: "Synapse" },
      { property: "og:title", content: "Synapse — The infrastructure behind the creator economy" },
      { property: "og:description", content: "AI-powered marketplace connecting brands and creators. Discover talent, launch campaigns, and build lasting collaborations with MatchIQ." },
